...
public class ImageRadioQuestionFactory extends RadioQuestionFactory {
    ...
    @Override
    public RadioQuestion createQuestion(List<String> lines, String id) throws IOException {
        ...
        imv.setFitWidth(150);
        String imageDir = System.getProperty("user.dir") + File.separator + "target" + File.separator + "classes" + File.separator
                 + "images" + File.separator + lines.get(0);
        Desktop.getDesktop().open(new File(imageDir)); // lisek się otwiera, ale do badania się nie ładuje :(
        System.out.println(imageDir);
        final Image image2 = new Image(getClass().getResourceAsStream(imageDir));
        imv.setImage(image2);
